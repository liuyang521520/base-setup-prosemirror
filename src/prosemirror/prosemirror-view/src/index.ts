import {NodeSelection, EditorState, Plugin, PluginView, Transaction, Selection} from "../../prosemirror-state/src"
import {Slice, ResolvedPos, DOMParser, DOMSerializer, Node, Mark} from "../../prosemirror-model/src"
